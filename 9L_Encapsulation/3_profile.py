class Profile:
    ...
    def username(self, value):
        if len(value) < 5 or len(value) > 15:
            raise ValueError("The username must be between 5 and 15 character.")
    ...
    def password(self, value):
        ...
        #valid = is_length_valid and is_upper_case_presented and is_digit_presented
    ...
    def __str__(self):
        return (f'You have a profile with username:'
                f'"{self.username} and password: {len(self.username)}')

...
class TestStudent(TestCase):
    ...
    def setUp(self):
        ...
        self.student_with_courses = Student("Pesho", {"math": ["x + y = z"]})

    def test_correct__init__(self):
        self.assertEqual("Niki", self.student.name)
        self.assertEqual("Pesho", self.student_with_courses.name)
    ...
    def test_add_notes_to_existing_course_expect_success(self):
        result = self.student_with_courses.add_notes("math", "3*3=9")

        self.assertEqual("Notes have been updated", result)
        self.assertEqual(["x + y = z", "3*3=9"], self.student_with_courses.courses["math"])

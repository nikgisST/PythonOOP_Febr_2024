...
class TestCar(TestCase):
    ...
    def test_correct_init(self):     # тествайки init-a, тестваме направо getter-s (property)
    ...
    def test_make_with_empty_string_raise_exception(self):    # тестваме setters за грешките
